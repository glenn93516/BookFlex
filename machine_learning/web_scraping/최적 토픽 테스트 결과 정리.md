...
1. 명사 테스트 1
   ...
   * 결과
   ...
   ![nn](https://lab.ssafy.com/s04-field/field-team4/blob/ML-unsupervised-hj/machine_learning/web_scraping/img/최적토픽테스트_start5_step3_max38_필터링O.png)
...
2. 명사 테스트 2
   ...
   * 결과
   ...
   ![nn](https://lab.ssafy.com/s04-field/field-team4/blob/ML-unsupervised-hj/machine_learning/web_scraping/img/최적토픽테스트_start5_step3_max38_필터링X.png)
...
3. 명사 테스트 3
   ...
   * 결과 
   ...
   ![nn](https://lab.ssafy.com/s04-field/field-team4/blob/ML-unsupervised-hj/machine_learning/web_scraping/img/최적토픽테스트_start4_step2_max30_필터링O.png)
...
## 데이터 셋  : 형용사
 ...
 1. 형용사 테스트 1
    ...
    * 결과 
    ...
    ![nn](https://lab.ssafy.com/s04-field/field-team4/blob/ML-unsupervised-hj/machine_learning/web_scraping/img/최적토픽테스트_형용사_start4_step2_max30_필터링O.png)
...
2. 형용사 테스트 2
   ...
   * 결과 
    ...
    ![nn](https://lab.ssafy.com/s04-field/field-team4/blob/ML-unsupervised-hj/machine_learning/web_scraping/img/최적토픽테스트_형용사_start4_step2_max30_필터링X.png)
...
## 데이터 셋  : 명사 + 형용사 (길이 1이상)
 ...
 1. 명사+형용사 테스트 1
    ...
    * 결과 
    ...
    ![nn](https://lab.ssafy.com/s04-field/field-team4/blob/ML-unsupervised-hj/machine_learning/web_scraping/img/최적토픽테스트_명사_형용사_start4_step2_max30_필터링O.png)
...
2. 명사+형용사 테스트 2
   ...
   * 결과 
     ...
     ![nn](https://lab.ssafy.com/s04-field/field-team4/blob/ML-unsupervised-hj/machine_learning/web_scraping/img/최적토픽테스트_명사_형용사_start4_step2_max30_필터링X.png)
