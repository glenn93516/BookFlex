    ...
    <div>
      ...
      <div style="float: right;" class="col-6">
        ...
        >
          ...
          ></b-form-radio-group>
        <div>
          <b-button class="mt-4 collect_btn col-12" @click="editSentence">문장 수정</b-button>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      book: {},
      file: null,
      text: this.item.highlightContent,
      sentencePage: this.item.highlightPage,
      options: [
        { item: 1, name: "공개" },
        { item: 0, name: "비공개" }
      ],
      selected: this.item.isPublic,
    }
  },
  created() {
